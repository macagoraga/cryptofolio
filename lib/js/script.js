...
function update() {
    ...
    $(".updownpct").each(function(){
        getupdown = $(this).index(".updownpct")
        paid = $(".paid:eq("+getupdown+")").text().replace("€ ", "")
        currentpl = parseFloat($(".updown:eq("+getupdown+")").text().replace("€ ", ""))
    ...
    $(".updownpct:contains('-'),.updown:contains('-'),.change:contains('-'),#profit:contains('-')").removeClass('positive negative').addClass('negative')
    $(".updownpct:not(:contains('-')),.updown:not(:contains('-')),.change:not(:contains('-')),#profit:not(:contains('-'))").removeClass('positive negative').addClass('positive')
    $("#totals,#holder").show()
