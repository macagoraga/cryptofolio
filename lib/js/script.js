...
$(function() {
    ...
    $("#charthide").click(function() {
        ...
        $("svg").remove()
        $("#chartcontainer,#charthide,#loader").hide()
        $("#table").show()
    ...
    $(".item").on("click", function(event) {
        ...
        // loadfeed = 'feed.php?symbol='+ encodeURI(chartsymbolname)
        // $("#load").load(loadfeed)
    });
    ...
    $("#1d").click(function() {
        ...
        loadgraph(currentchart, 'minutes', '1440');
    })
    ...
    $("#7d").click(function() {
        ...
        loadgraph(currentchart, 'hours', '168');
    })
    ...
    $("#1m").click(function() {
        ...
        loadgraph(currentchart, 'hours', '720');
    })
    ...
    $("#3m").click(function() {
        ...
        loadgraph(currentchart, 'days', '90');
    })
    ...
    var displayData = function(current, from, tsym, fsym) {
        ...
        for (var key in current) {
            ...
            if (key == 'PRICE') {
                ...
                if (priceDirection & 1) {
                    swapcolor(element, 'positive', '')
                }
                if (priceDirection & 2) {
                    swapcolor(element, 'negative', '')
                }
