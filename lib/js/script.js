...
$(function() {
    ...
    $("#form").on('click', '#apiform', function() {
        ...
        $.post("editapi.php", {
            ...
            $("input[name='password']").val(r.user.password)
            ...
            $("input[name='kucoinapi']").val(r.api.kucoin.api)
            $("input[name='kucoinsecret']").val(r.api.kucoin.secret)
...
function portfolio() {
    ...
    $.ajax({
        ...
        complete: function(json) {
            ...
            $(".filter a:contains('ALL')").trigger('click')
            update();
