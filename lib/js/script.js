...
function update() {
    ...
    $(".change:contains('-')").removeClass('positive negative').addClass('negative')
    $(".change:not(:contains('-'))").removeClass('positive negative').addClass('positive')
    $("#totals,#holder").show()
